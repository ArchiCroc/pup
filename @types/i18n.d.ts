...
declare module 'meteor/universe:i18n' {
    ...
    //namespace i18n {
        ...
        function ___(key: string, params?: GetTranslationParams): string;
        function ___(namespace: string, key: string, params: GetTranslationParams): string;
        function ___(...key: string[]): string;
