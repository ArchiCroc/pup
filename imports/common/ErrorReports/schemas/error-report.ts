...
/* #### PLOP_IMPORTS_END #### */
import parseObjectID from '/imports/common/libs/parseObjectID';

const cleanLevel = (item: string) => parseInt(item, 10);
...
const ErrorReportSchema = new SimpleSchema({
  ...
  level: {
    ...
    uniforms: {
      ...
      transform: (value: any) => i18n.__(`ErrorReports.level_${value}`),
    },
  },
  message: {
    type: String,
