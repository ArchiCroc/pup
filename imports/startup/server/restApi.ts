 ...
 */
const handleErrorAsHalJson = (error: any, request: any, response: any, next: any) => {
  console.log(error);
...
const validateApikey = async (key: string, secret: string) => {
  if (key && secret) {
...
const parseBasicAuth = async (request: any, response: any, next: any) => {
...
const parseAuthToken = (request: any, response: any, next: any) => {
...
ApiRoutes.Error = (message: string, detail: any, code: number) => {
